...
THIS IS CLONE FROM: ['fastify-oauth2'](https://github.com/fastify/fastify-oauth2) with support for multiple strategies based on [PR #34](https://github.com/fastify/fastify-oauth2/pull/34) which still is neither accepted nor rejected thus not merged.
